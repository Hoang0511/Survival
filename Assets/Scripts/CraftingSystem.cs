...
public class CraftingSystem : MonoBehaviour
{
    ...
    public GameObject craftScreenUI;
    ...
    // Requirement Text
    Text AxeReq1, AxeReq2, PlankReq1, FoundationReq1, WallReq1, StorageBoxReq1, CampfireReq1;
    ...
    private Blueprint storageBoxBLP = new Blueprint("StorageBox", 1, 1, "Plank", 2, "", 0);
    private Blueprint campfireBLP = new Blueprint("Campfire", 1, 1, "Stone", 2, "", 0);
    ...
    public Blueprint AxeBLP { get => axeBLP; set => axeBLP = value; }
    ...
    IEnumerator craftedDelayForSound(Blueprint blueprintToCraft)
    {
        ...
        for (var i = 0; i < blueprintToCraft.numberOfItemProduce; i++)
        {
    ...
    public void RefreshNeededItem()
    {
        ...
        CampfireReq1.text = "2 Stone [" + stone_count + "]";

        if (stone_count >= 2 && InventorySystem.Instance.CheckSlotAvailable(1))
        {
